...
class IA:
	...
	def learn_experiance_once(self, rules, deeps=4, add=0.1, debug=False):
	...
	def learn_by_experiance(self, rules, rate_similarity=0.1, cmd_gui=False):

		print('[Ok] Stating learning by experience process')

		diff = lambda lst1, lst2: sum([lst1[x]-lst2[x] for x in range(len(lst1))])
